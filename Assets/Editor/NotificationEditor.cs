...
public class NotificationEditor : Editor
{
    ...
    SerializedProperty inputBinding;
    ...
    void OnEnable()
    {
        ...
        inputBinding = serializedObject.FindProperty("inputBinding");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(inputBinding, new GUIContent("Input Binding: "));
